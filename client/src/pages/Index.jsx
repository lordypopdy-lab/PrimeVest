  ...
  return (
    <div className="flex flex-col min-h-[100dvh] dark">
          ...
          <Container>
            ...
            <Row className="mt-5 g-4">
              <Col lg={6}>
                <Card className="p-4 bg-black border">
                  <p className="bitradex-text-muted">
                    ...
                    PrimeVest-Markets stands out with its security features, low
              ...
              <Col lg={6}>
                <Card className="p-4 bg-black border">
                  <p className="bitradex-text-muted">
                    "PrimeVest-Markets has transformed the way I invest in
        ...
        >
          <Container className="text-center">
            ...
            <p className="bitradex-text-muted mt-2">
              Join thousands of investors on PrimeVest-Markets.
            </p>
      ...
      <footer className="py-3 border-top text-center">
        <p className="bitradex-text-muted small">
          © {new Date().getFullYear()} PrimeVest-Markets. All rights reserved.
        </p>
